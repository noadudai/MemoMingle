...
const Navbar = () => {
    ...
    return (
        <div className="w-screen h-[80px] z-10 bg-orange-200 fixed drop-shadow-lg">
            <div className='px-2 flex justify-between items-center w-full h-full'>
                <div className="flex items-center">
                    <h1 className="text-xl mr-4 font-bold">Memo Mingle</h1>
                </div>
            </div>
            ...
            <div className={!nav ? "hidden" : "absolute bg-orange-200 px-8 flex flex-col my-4"}>
